...
const API_KEY = 'GDeInLdDTlEHVqATc6PTGTQup2BFqrMUIt2R9JBn'
const API_URL = `https://api.nasa.gov/insight_weather/?api_key=${API_KEY}&
...
function displaySelectedSol(sols) {
  ...
  console.log(sols)
  console.log(sols[selectedSolIndex])
